...
class _StyleOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color circleColor = isSelected ? AppColors.primary : Colors.white.withOpacity(0.15);
    final Color borderColor = isSelected ?AppColors.primary : Colors.white.withOpacity(0.25);
    final Color iconColor = isSelected ? AppColors.black : Colors.white.withOpacity(0.5);
...
class OnboardingStepStyle extends StatelessWidget {
  final List<String> styles = ["Básico", "Elegante", "Street Wear", "Boho Chic", "Otros"];
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<OnboardingBloc, OnboardingState>(
      builder: (context, state) {
        ...
        final isReadyToProceed = selectedStyle != null && selectedStyle.isNotEmpty; 
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: isReadyToProceed ? Colors.yellow : Colors.white.withOpacity(0.1),
